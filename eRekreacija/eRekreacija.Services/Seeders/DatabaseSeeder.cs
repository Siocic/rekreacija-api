...
namespace eRekreacija.Services.Seeders
{
    public class DatabaseSeeder
    {
        ...
        private static async Task SeedReview(RekreacijaContext context)
        {
            ...
            {
                new tbl_Review{id=1,comment="Savršena dvorana! Sve je čisto, moderno i odlično organizovano. Definitivno se vraćam!",rating=5,user_id="326aa2d9-36a5-41e7-ab17-2339db9d7dbb",object_id=1},
                new tbl_Review{id=2,comment="Vrlo ljubazno osoblje, odlična rasvjeta i kvalitetan parket. Sve preporuke!",rating=5,user_id="d70faa87-9cf2-4cd7-808f-81e34b8dee04",object_id=2},
                new tbl_Review{id=3,comment="Igrali smo turnir i sve je prošlo bez greške. Odlična akustika i klimatizacija.",rating=5,user_id="d70faa87-9cf2-4cd7-808f-81e34b8dee04",object_id=5},
                new tbl_Review{id=4,comment="Jedna od boljih dvorana u gradu. Ima sve što treba za ozbiljan trening.",rating=5,user_id="2a38f91f-00fe-4161-b694-77f30f1d4036",object_id=1},
                new tbl_Review{id=5,comment="Super atmosfera i dobra oprema. Rezervacija termina ide glatko.",rating=5,user_id="326aa2d9-36a5-41e7-ab17-2339db9d7dbb",object_id=8},
                new tbl_Review{id=6,comment="Vrlo dobra dvorana, ali svlačionice bi mogle biti malo modernije.",rating=3,user_id="ce9e09e0-29c7-4ef5-9a76-c020dae967f5",object_id=6},
                new tbl_Review{id=7,comment="Generalno zadovoljan, samo ponekad bude gužva na parkingu.",rating=4,user_id="8b5f3087-4554-497f-9cd8-df61793e083a",object_id=1},
                new tbl_Review{id=8,comment="Dvorana je okej, ali mreže za odbojku su bile malo oštećene.",rating=4,user_id="ce9e09e0-29c7-4ef5-9a76-c020dae967f5",object_id=10},
                new tbl_Review{id=9,comment="Sve je bilo super, samo bi rasvjeta mogla biti bolja u večernjim terminima.",rating=4,user_id="ce9e09e0-29c7-4ef5-9a76-c020dae967f5",object_id=9},
                new tbl_Review{id=10,comment="Lijep prostor i dobra organizacija, ali klima nije uvijek dovoljno jaka.",rating=4,user_id="2a38f91f-00fe-4161-b694-77f30f1d4036",object_id=5},
                new tbl_Review{id=11,comment="Teren je savršeno održavan, mreža čvrsta, idealno za rekreaciju i ozbiljan tenis.",rating=5,user_id="d70faa87-9cf2-4cd7-808f-81e34b8dee04",object_id=7},
                new tbl_Review{id=12,comment="Teren je ok, ali okolina nije baš uređena. Svejedno fino smo odigrali.",rating=3,user_id="2a38f91f-00fe-4161-b694-77f30f1d4036",object_id=9},
                new tbl_Review{id=13,comment="Trebalo bi da se linije češće obnavljaju, ali generalno dobar teren.",rating=3,user_id="ce9e09e0-29c7-4ef5-9a76-c020dae967f5",object_id=7},
                new tbl_Review{id=14,comment="Nedovoljno svlačionica za veće grupe. Teren je okej.",rating=2,user_id="ce9e09e0-29c7-4ef5-9a76-c020dae967f5",object_id=10},
                new tbl_Review{id=15,comment="Solidno iskustvo, ali bi mogli srediti bolje označene linije za različite sportove.",rating=2,user_id="326aa2d9-36a5-41e7-ab17-2339db9d7dbb",object_id=4},
                new tbl_Review{id=16,comment="Odličan mali teren! Idealna podloga i super rasvjeta za večernje termine.",rating=5,user_id="8b5f3087-4554-497f-9cd8-df61793e083a",object_id=3},
                new tbl_Review{id=17,comment="Teren je solidan, linije su jasno označene, ali mreža na golovima bi mogla biti u boljem stanju.",rating=4,user_id="d70faa87-9cf2-4cd7-808f-81e34b8dee04",object_id=3},
                new tbl_Review{id=18,comment="Savršeno mjesto za rekreativno igranje sa ekipom! Rezervacija je bila brza i bez problema.",rating=5,user_id="326aa2d9-36a5-41e7-ab17-2339db9d7dbb",object_id=3},
            };
